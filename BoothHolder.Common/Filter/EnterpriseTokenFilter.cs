...
{
    public class EnterpriseTokenFilter : IAsyncActionFilter
    {
        private readonly IDatabase _database;
        private readonly string _enterpriseredistoken = "enterprisetoken:";


        public EnterpriseTokenFilter(IConnectionMultiplexer connection)
        {
