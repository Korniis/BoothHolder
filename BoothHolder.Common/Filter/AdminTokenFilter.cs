...
namespace BoothHolder.Common.Filter
{
    ...
    public class AdminTokenFilter : IAsyncActionFilter
    {
        private readonly IDatabase _database;
        private readonly string __adminredistoken = "admintoken:";

        public AdminTokenFilter(IConnectionMultiplexer connection)
        {
        ...
        private async Task<bool> ValidateTokenAsync(string actualToken, IEnumerable<Claim> claims)
        {
            ...
            var redistoken = await _database.StringGetAsync(__adminredistoken + userNameClaim.Value);
